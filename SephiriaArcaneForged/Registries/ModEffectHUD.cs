...
namespace SephiriaArcaneForged.Registries
{
    public class ModEffectHUD
    {
        ...
        public static ModEffectHUD CreateStackEffectHUD(string name, bool hasStackText = true, Image.FillMethod fill = Image.FillMethod.Radial360)
        {
            ...
            hud.IconFileName = AssetLoader.EffectHUDPath + name;
        ...
        public void SetResourcePrefab(GameObject prefab)
        {
            ...
            icon.sprite = (Icon ?? AssetLoader.LoadSprite(IconFileName)) ?? AssetLoader.LoadSprite(AssetLoader.EffectHUDPath + "Empty");
